...
let expected: object = {myString: "myValue", list: [1,2,3], myNumber: 5, myBoolean: true, myBoolean2: false, myObject: {key: "myValue", list: [1,2,3], myNumber: 5, myBoolean: true, myBoolean2: true}};
