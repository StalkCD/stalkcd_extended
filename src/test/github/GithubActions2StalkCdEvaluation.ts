...
export class GithubActions2StalkCdEvaluation {
    ...
    static {
        ...
        this.expectedResultMap.set("JobUses", 43)
        this.expectedResultMap.set("JobWith", 18)
        this.expectedResultMap.set("JobSecrets", 12)
        this.expectedResultMap.set("StepId", 1068)
        ...
        this.expectedResultMap.set("StepContinueOnError", 197)
        this.expectedResultMap.set("ValidationFailed", 95)
        this.expectedResultMap.set("UnknownError", 50)
        this.expectedResultMap.set("StepWithArgs", 64)
