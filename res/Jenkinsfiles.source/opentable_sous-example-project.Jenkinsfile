...
pipeline {
  ...
  // Version 0.0.1
  // Generated: 10 Oct 18 16:20 BST
  // ManifestID: github.com/opentable/sous-example-project
  options {
  ...
  parameters {
    string(defaultValue: 'semver_timestamp', description: 'How sous determines build / deploy version', name: 'SOUS_VERSIONING_SCHEME')
      string(defaultValue: 'NO', description: 'Execute Static Tests', name: 'SOUS_STATIC_TEST')
      string(defaultValue: 'make static', description: 'Static Tests Command', name: 'SOUS_STATIC_TEST_COMMAND')
      string(defaultValue: 'NO', description: 'Execute Unit Tests', name: 'SOUS_UNIT_TEST')
      string(defaultValue: 'make unit', description: 'Unit Tests Command', name: 'SOUS_UNIT_TEST_COMMAND')
      string(defaultValue: 'NO', description: 'Execute Smoke Tests', name: 'SOUS_SMOKE_TEST')
      string(defaultValue: 'make smoke', description: 'Smoke Tests Command', name: 'SOUS_SMOKE_TEST_COMMAND')
      string(defaultValue: 'NO', description: 'Execute Integration Tests', name: 'SOUS_INTEGRATION_TEST')
